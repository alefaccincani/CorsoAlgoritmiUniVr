% ============================================================
% PREAMBOLO — Algoritmi per Bioinformatica
...
\usepackage{slantsc}   % abilita \textscsl (small caps slanted)
...
% --- AMBIENTI COLORATI ---
% tcolorbox caricato dopo amsthm per evitare conflitti
\usepackage{mdframed} 
...
\definecolor{correctgreen}{RGB}{0, 140, 0}
\definecolor{qbg}{RGB}{245, 248, 255}
...
% Approfondimenti tecnici / dettagli implementativi
\newenvironment{nota}{%
	\begin{tcolorbox}[
		colback=codebg,
		colframe=primary,
...
% Intuizioni e spiegazioni introduttive
...
% Punti critici, errori comuni, caveat da ricordare all'esame
...
\SetKw{KwAnd}{and}
\SetKw{KwOr}{or}
% Con [onelanguage], \KwRet è già definito internamente;
% \providecommand evita "already defined":
...
% Definizione dello stile 'java' per lstlisting
\lstdefinestyle{java}{
	language=Java,
