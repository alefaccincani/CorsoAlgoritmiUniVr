...
inizio:
Q = <2>
colori: 2 grigio, altri bianchi
d: 2=0

dopo scansione di 2:
Q = <1,4>
colori: 1,4 grigi; 2 nero
d: 1=1, 4=1
pi: 1<-2, 4<-2
...
Ordinamento topologico possibile:

a  c  b  d

Tutti gli archi vanno da sinistra verso destra.
\end{verbatim}
\end{center}
...
La seconda DFS su G^T, nell'ordine corretto,
estrae un albero per ciascuna componente.
\end{verbatim}
\end{center}
